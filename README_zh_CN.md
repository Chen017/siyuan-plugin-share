...
- **免费开源，可直接上手**  
  插件本体免费、开源，不需要额外付费才能使用核心分享能力。

- **公有服务开箱即用 + 私有部署可选**  
  可直接使用 `share.b0x.top` 快速开始；也支持私有化部署，支持 Docker 部署、NAS 部署，以及宝塔面板或其他面板部署。

- **分享范围更灵活**  
  支持分享 **笔记本**、**单篇文档**、**文档及子文档** 三种范围。

- **支持增量更新，不必每次分享全量上传**  
  内容更新走增量同步，减少重复上传，速度更快、流量更省。

- **支持排除特定文档**  
  分享时可排除指定文档，避免不需要公开的内容被一并分享。

- **内置访问统计概览**  
  可查看分享 **浏览量（PV）**、**访客数（UV）**、**IP 数量**、**访客地域分析** 等数据，便于评估分享效果。
