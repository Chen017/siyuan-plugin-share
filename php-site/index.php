...
function render_page(string $title, string $content, ?array $user = null, string $baseHref = '', array $options = []): void {
    ...
    if ($layout === 'share') {
        echo "<style id='sps-share-font-force'>body.layout-share .markdown-body,body.layout-share .markdown-body :where(p,li,a,span,strong,em,del,mark,h1,h2,h3,h4,h5,h6,blockquote,td,th,div){font-family:'misansvf',sans-serif !important;}</style>";
    }
    echo "</head>";
