...
function render_page(string $title, string $content, ?array $user = null, string $baseHref = '', array $options = []): void {
    ...
    if ($layout === 'auth') {
        ...
        echo $content;
        echo "<footer class='share-footer'><a href='https://github.com/b8l8u8e8/siyuan-plugin-share' target='_blank' rel='noopener noreferrer'>b8l8u8e8</a> 提供上游支持 | 我的<a href='https://github.com/Chen017/siyuan-plugin-share' target='_blank' rel='noopener noreferrer'> Fork</a></footer>";
